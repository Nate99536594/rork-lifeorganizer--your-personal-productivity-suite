...
export default function HealthScreen() {
  ...
  const handleUpgradeToPremium = async () => {
    if (Platform.OS !== 'ios') {
      Alert.alert('Not Available', 'Payment is only available on iOS devices.');
      return;
    }
        ...
        <View style={[styles.premiumModalContent, { backgroundColor: colors.background.primary }]}>
          ...
          <View style={styles.premiumActions}>
            {Platform.OS === 'ios' ? (
              ...
              <View style={[styles.unavailableButton, { backgroundColor: colors.text.light }]}>
                <Text style={[styles.unavailableButtonText, { fontFamily: colors.fonts?.semiBold }]}>
